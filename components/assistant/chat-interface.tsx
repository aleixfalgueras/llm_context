    ...
    <div className="max-w-2xl mx-auto text-center">
      ...
      <Card className="mx-4 mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
        <div className="flex items-center justify-center mb-3">
          ...
          <h3 className="font-semibold text-blue-800 dark:text-blue-300">{t('getStarted')}</h3>
        </div>
...
{isCreatingGeneralChat ? t('starting') : t('newChat')}
            </Button>
          </div>
        </div>
      </Card>
      ...
      <Card className="mx-4 mb-6 p-4 bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800">
        <div className="flex items-center justify-center mb-2">
          ...
          <h3 className="font-semibold text-green-800 dark:text-green-300">{t('privacyProtected')}</h3>
        </div>
