...
export const AffiliationStatusConditions = {
  ...
  [AffiliationStatus.CristalClub]: `100 users & 1 ${AffiliationStatusEmoji[AffiliationStatus.GenY]} user`,
  [AffiliationStatus.D5Level]: `200 users & 5 ${AffiliationStatusEmoji[AffiliationStatus.GenY]} users`,
  [AffiliationStatus.Walkin]: `400 users & 10 ${AffiliationStatusEmoji[AffiliationStatus.GenY]} users`,
  [AffiliationStatus.SevenStars]: `1000 users & 1 ${AffiliationStatusEmoji[AffiliationStatus.CristalClub]} user`,
  [AffiliationStatus.InfinityStars]: `2000 users & 5 ${AffiliationStatusEmoji[AffiliationStatus.CristalClub]} users`,
  [AffiliationStatus.Alpha]: `4000 users & 10 ${AffiliationStatusEmoji[AffiliationStatus.CristalClub]} users`,
  [AffiliationStatus.Omega]: `1000 users & 1 ${AffiliationStatusEmoji[AffiliationStatus.SevenStars]} user`,
}
