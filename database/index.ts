...
export { DealOperations } from './deal-operations'
...
export { SubscriptionUsageOperations } from './subscription-usage-operations'
export { AffiliationOperations } from './affiliation-operations'
export { DynamicTextOperations } from './dynamic-text-operations'
